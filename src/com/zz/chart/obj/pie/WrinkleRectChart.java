...
import com.zz.chart.render.pie.WrinkleRectPlot;
...
//        int hUnit = (int) Math.rint(sizeUnit.height);
		...
		BufferedImage image = new BufferedImage((int) (width+100),(int) (hStruTitle+maxH+width*1.2), BufferedImage.TYPE_INT_ARGB);
