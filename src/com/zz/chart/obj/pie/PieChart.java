...
import com.zz.chart.render.pie.TPiePlot;
...
//		plot.setSectionOutlinesVisible(SectionOutlinesVisible);
		...
		Rectangle2D.Double symbolEnvlope =  new Rectangle2D.Double( x-width/2,y-width/2, width,width);
	...
	public BufferedImage drawLegend(int width, int height,
		...
		BufferedImage pieStruLegend=pieStruChart.createBufferedImage(width*2+50, (int) (width+25),null);
		...
		BufferedImage image = new BufferedImage((int) (width*2+50),hStruTitle+maxH+width, BufferedImage.TYPE_INT_ARGB);
...
//		Rectangle2D.Double pierect = new Rectangle2D.Double((image.getWidth()-pieStruLegend.getWidth())/2,hStruTitle,pieStruLegend.getWidth(),pieStruLegend.getHeight());
		//g2d.draw(pierect);
		Rectangle2D.Double rect = new Rectangle2D.Double(1, width+25, width*2+50, width+50);
...
//		double R1 = width/2;
		...
		Rectangle2D.Double rect1 = new Rectangle2D.Double(1, width, width*2+50, width+50);
